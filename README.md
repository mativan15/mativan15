...
Designed and implemented a database storage simulation system focused on indexing and physical storage organization.
...
Business-oriented mobile application for inventory management and automated PDF work-order generation.

### Features
- Real-time product search
- Firestore multi-filter querying
- Dynamic PDF generation
- Inventory workflows
- Responsive Flutter UI

### Focus Areas
`Flutter` • `Firebase` • `Firestore` • `PDF Generation`
